...
write_llama_runtime_env() {
  ...
  for key in LLAMA_BIN MODEL_PATH MMPROJ_PATH LLAMA_HOST LLAMA_PORT LLAMA_CTX LLAMA_PARALLEL LLAMA_GPU_LAYERS LLAMA_FLASH_ATTENTION LLAMA_JINJA LLAMA_MLOCK LLAMA_EXTRA_ARGS; do
    value="${!key:-}"
