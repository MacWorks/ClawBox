...
write_env_from_template() {
  ...
  replace_template_value "$temp_file" "EMBEDDINGS_LLAMA_PORT" "${EMBEDDINGS_LLAMA_PORT:-}"
  replace_template_value "$temp_file" "EMBEDDINGS_LLAMA_CTX" "${EMBEDDINGS_LLAMA_CTX:-}"
  replace_template_value "$temp_file" "EMBEDDINGS_LLAMA_EXTRA_ARGS" "${EMBEDDINGS_LLAMA_EXTRA_ARGS:-}"
  replace_template_value "$temp_file" "EMBEDDINGS_LLAMA_BASE_URL" "${EMBEDDINGS_LLAMA_BASE_URL:-}"
